...
#Lsdl: {
	...
	#state: "UserAuthored" | "Generated" | "Deleted" | *"UserAuthored"
	...
	#instanceSynonyms: {
		// The conceptual model object which contains words that can be
	...
	#phrasing: (#attributePhrasing | #namePhrasing | #adjectivePhrasing | #dynamicAdjectivePhrasing | #nounPhrasing | #dynamicNounPhrasing | #prepositionPhrasing | #verbPhrasing) & #sharedPhrasingProperties
